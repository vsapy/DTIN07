...
# with a delay of 2*bits*ms so that it arrives in pahse with the next spike from the G1 neurons.  Using the refractory 
...
G2 = NeuronGroup(slots, equ2, threshold= 'v>=0.5', reset='v=0.0', method='euler',refractory ='t%(2*bits*ms)')
